"""
Tests parameters to ensure deterministic model output.
"""
...
class TestBench:
    def test_openai_whisper_large_v2(self) -> None:
        res = bench(
            "openai/whisper-large-v2", BenchArgs(hf_batch_size=24, hf_chunk_length_s=30)
        )
    ...
    def test_openai_whisper_large_v3_turbo(self) -> None:
        res = bench(
            ...
            BenchArgs(hf_batch_size=24, hf_chunk_length_s=30),
        )
        assert (
            res.get_text()
